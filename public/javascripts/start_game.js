...
function display_next_question(){
    ...
    current_question = question_set[count];
    let question = current_question["question"];
    let ans_a = current_question["A"];
    let ans_b = current_question["B"];
    let ans_c = current_question["C"];
    let ans_d = current_question["D"];
    document.getElementById("A_button_text").innerHTML = ans_a;
    document.getElementById("B_button_text").innerHTML = ans_b;
    document.getElementById("C_button_text").innerHTML = ans_c;
    document.getElementById("D_button_text").innerHTML = ans_d;
...
function guess_answer(button_id){
    ...
    if(guess_letter === current_question["answer"]){
